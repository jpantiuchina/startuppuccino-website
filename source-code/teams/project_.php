...
<html>
	<head>
		...
		<title><?php htmlspecialchars($projectTitle); ?> - Startuppuccino</title>
	...
	<body>
		...
		<h1><?php htmlspecialchars($projectTitle); ?></h1>

		<p style="white-space: pre-line"><?php htmlspecialchars($projectDescription) ?></p>
