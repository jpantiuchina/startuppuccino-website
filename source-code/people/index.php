				...
				if ($person = $people_func->getPersonInfo()) {
					...
					<section>
						...
						<div class="profile_head">
							<h3 class="profile_name"><?php echo $person["firstname"] . " " . $person["lastname"]; ?></h3>
							<p class="profile_role"><?php echo $person["role"]; ?></p>
						</div>
					...
					<section class="profile_details">
						...
						<p class="profile_details__about"><?php echo $person["about"]; ?></p>	
