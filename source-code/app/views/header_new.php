...
<header>
    ...
    <nav class="menu">
    	...
    	<ul>
			...
			<li class="menu_link--top"><a href="../ideas/">Ideas</a></li>

				<li class="menu_link--top"><a href="../teams/">Projects</a></li>
				
        	<li class="menu_link--top"><a href="#" onclick="Sp.layout.toggleSearch()">Search</a></li>
        	...
        	<li class="menu_link submenu_trigger">
        		<div class="menu_profile_picture" style="background-image: url('../app/assets/pics/people/<?php printAvatar();?>')" alt="Profile">
        			<div class="role_filer--<?php echo $_SESSION['role'];?>"></div>
        		</div> 
        		<ul class="submenu">
